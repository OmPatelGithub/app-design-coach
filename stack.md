...
- [Figma](https://figma.com) — design surface
- [Claude](https://claude.ai) — mockups via Claude Design, general AI work
- [figma-asset-maker](./figma-asset-maker/) — turn screen recordings into Figma frames
...
- [TikAPI](https://tikapi.io) or [viral.app](https://viral.app) — TikTok analytics, view tracking
